/**
 * @description
 * Controller for handling System updates
 */
(function (angular) {
    "use strict";
    angular.module('dataVINEApp').controller('systemUpdatesCtrl',
        ['$scope', '$rootScope', '$uibModal', '$timeout', 'hypersproutMgmtService',
            ...
            'type', 'formatDate',
            function ($scope, $rootScope, $uibModal, $timeout, hypersproutConfigService, $filter, refreshservice,
                      $controller, type, formatDate, deviceService, $templateCache, commonService, $sessionStorage) {
            ...
            $scope.initializeTable = function (pageNum) {
                ...
                $scope.jobStatusGrid.columnDefs = [
                    ...
                    { field: 'DeviceType', enableHiding: false },
                    {
            ...
            function initData(pageNum, limit) {
                ...
                deviceService.fetchJobStatus("All", pageNum, limit, $scope.queryParamForAPI)
                    .then(function (apiData) {
                        if (!angular.isUndefinedOrNull(apiData) && apiData.type) {
                            ...
                            for (let i = 0; i < apiData.length; i++) {
                                ...
                                objToInsert["DeviceType"] = angular.isUndefinedOrNull(apiData[i].DeviceType) ? '-' : commonService.addTrademark(apiData[i].DeviceType);
