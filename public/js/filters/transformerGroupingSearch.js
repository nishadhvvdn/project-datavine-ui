/**
 * Filter for transformer groupings
 */
(function (angular) {
    "use strict";
    angular
        .module('dataVINEApp')
        .filter('transformerGroupingSearch', ['commonService',
            function (commonService) {
                return function (arrInputData, transformerSearchValue) {
                    if (!angular.isUndefined(arrInputData) &&
                        !angular.isUndefined(transformerSearchValue)) {
                        var arrOutputData = [];
                        ...
                        angular.forEach(arrInputData,
                            function (objectData) {
                                ...
                                var noOfMeters = (commonService.convert(objectData.noOfMeters)).toLowerCase();
                                ...
                                if (transformerSl.indexOf(transformerSearchValue) >= 0 ||
                                    noOfMeters.indexOf(transformerSearchValue) >= 0 ||
