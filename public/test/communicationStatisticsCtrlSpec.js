...
//     var scope, communicationStatisticsCtrl,httpBackend, refreshservice,reportsService,timeout,filter;
...
//             communicationStatisticsCtrl = $controller('hypersproutCommCtrl', {
//                 '$scope': scope,
...
'use strict';
describe('communicationStatisticsCtrl testing', function () {

    var scope, communicationStatisticsCtrl,state,location;
    ...
    beforeEach(function () {
        inject(function ($injector, $controller, $rootScope) {
            ...
            state={go:function(){},current:{name:'reports.communicationStatistics'}};
            spyOn(state,'go');
            

            communicationStatisticsCtrl = $controller('communicationStatisticsCtrl', {
                '$scope': scope,
                '$state': state,
                '$location': location,
